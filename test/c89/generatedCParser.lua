...
direct_declarator <-  (id  /  '(' declarator ')') ('[' const_exp? ']'^Err_005  /  '(' param_type_list ')'  /  '(' id_list? ')'^Err_006)*
...
char_const      <-  "'" ('\n'  /  !"'" .) "'"
string          <-  '"' ('\n'  /  !'"' .)* '"'
esc_char        <-  '\\' ('n'  /  't'  /  'v'  /  'b'  /  'r'  /  'f'  /  'a'  /  '\\'  /  '?'  /  "'"  /  '"'  /  [01234567] [01234567]? [01234567]?  /  'x' xdigit^Err_025)^Err_026
