...
UniqueFlwVar	abstract_declarator	rule = 	direct_abstract_declarator	pref = 	(	flw = 	)	rep = 	nil
foi true22
passou três	const_exp	stat
UniqueFlwVar	const_exp	rule = 	stat	pref = 	case	flw = 	:	rep = 	nil
foi true22
foi true22
foi true22
...
foi true22
passou três	stat	stat
UniqueFlwVar	stat	rule = 	stat	pref = 	do	flw = 	while	rep = 	nil
foi true22
foi true22
foi true22
foi true22
...
UniqueFlwVar	exp	rule = 	stat	pref = 	return	flw = 	;	rep = 	true
foi true22
passou três	exp	conditional_exp
UniqueFlwVar	exp	rule = 	conditional_exp	pref = 	?	flw = 	:	rep = 	nil
foi true22
...
UniqueFlwVar	exp	rule = 	postfix_exp	pref = 	[	flw = 	]	rep = 	false
foi true22
foi true22
...
type_spec       <-  'void'  /  'char'  /  'short'  /  'int'  /  'long'  /  'float'  /  'double'  /  'signed'  /  'unsigned'  /  typedef_name  /  'enum' ID? '{' enumerator^Err_002 (',' enumerator^Err_003)* '}'^Err_004  /  'enum' ID^Err_005  /  struct_or_union ID? '{' struct_decl+^Err_006 '}'^Err_007  /  struct_or_union ID^Err_008
type_qualifier  <-  'const'  /  'volatile'
struct_or_union <-  'struct'  /  'union'
...
enumerator      <-  (ID '=' const_exp  /  ID)^Err_009
...
direct_abstract_declarator <-  '(' abstract_declarator ')' ('[' const_exp? ']'^Err_010  /  '(' param_type_list? ')'^Err_011)*
typedef_name    <-  ID
stat            <-  ID ':' stat  /  'case' const_exp^Err_012 ':'^Err_013 stat^Err_014  /  'default' ':'^Err_015 stat^Err_016  /  exp? ';'  /  compound_stat  /  'if' '('^Err_017 exp^Err_018 ')' stat 'else' stat^Err_019  /  'if' '('^Err_020 exp^Err_021 ')'^Err_022 stat^Err_023  /  'switch' '('^Err_024 exp^Err_025 ')'^Err_026 stat^Err_027  /  'while' '('^Err_028 exp^Err_029 ')'^Err_030 stat^Err_031  /  'do' stat^Err_032 'while'^Err_033 '('^Err_034 exp^Err_035 ')'^Err_036 ';'^Err_037  /  'for' '('^Err_038 exp? ';'^Err_039 exp? ';'^Err_040 exp? ')'^Err_041 stat^Err_042  /  'goto' ID^Err_043 ';'^Err_044  /  'continue' ';'^Err_045  /  'break' ';'^Err_046  /  'return' exp? ';'^Err_047
...
Err_015         <-  (!('~'  /  '{'  /  'while'  /  'switch'  /  'sizeof'  /  'return'  /  'if'  /  'goto'  /  'for'  /  'do'  /  'default'  /  'continue'  /  'case'  /  'break'  /  STRING  /  INT_CONST  /  ID  /  FLOAT_CONST  /  ENUMERATION_CONST  /  CHAR_CONST  /  ';'  /  '--'  /  '-'  /  '++'  /  '+'  /  '*'  /  '('  /  '&'  /  '!') EatToken)*
Err_016         <-  (!('~'  /  '}'  /  '{'  /  'while'  /  'switch'  /  'sizeof'  /  'return'  /  'if'  /  'goto'  /  'for'  /  'else'  /  'do'  /  'default'  /  'continue'  /  'case'  /  'break'  /  STRING  /  INT_CONST  /  ID  /  FLOAT_CONST  /  ENUMERATION_CONST  /  CHAR_CONST  /  ';'  /  '--'  /  '-'  /  '++'  /  '+'  /  '*'  /  '('  /  '&'  /  '!') EatToken)*
Err_017         <-  (!('~'  /  'sizeof'  /  STRING  /  INT_CONST  /  ID  /  FLOAT_CONST  /  ENUMERATION_CONST  /  CHAR_CONST  /  '--'  /  '-'  /  '++'  /  '+'  /  '*'  /  '('  /  '&'  /  '!') EatToken)*
Err_018         <-  (!')' EatToken)*
...
Err_041         <-  (!('~'  /  '{'  /  'while'  /  'switch'  /  'sizeof'  /  'return'  /  'if'  /  'goto'  /  'for'  /  'do'  /  'default'  /  'continue'  /  'case'  /  'break'  /  STRING  /  INT_CONST  /  ID  /  FLOAT_CONST  /  ENUMERATION_CONST  /  CHAR_CONST  /  ';'  /  '--'  /  '-'  /  '++'  /  '+'  /  '*'  /  '('  /  '&'  /  '!') EatToken)*
...
Err_043         <-  (!';' EatToken)*
Err_044         <-  (!('~'  /  '}'  /  '{'  /  'while'  /  'switch'  /  'sizeof'  /  'return'  /  'if'  /  'goto'  /  'for'  /  'else'  /  'do'  /  'default'  /  'continue'  /  'case'  /  'break'  /  STRING  /  INT_CONST  /  ID  /  FLOAT_CONST  /  ENUMERATION_CONST  /  CHAR_CONST  /  ';'  /  '--'  /  '-'  /  '++'  /  '+'  /  '*'  /  '('  /  '&'  /  '!') EatToken)*
...
Err_048         <-  (!':' EatToken)*
Err_049         <-  (!('~'  /  'sizeof'  /  STRING  /  INT_CONST  /  ID  /  FLOAT_CONST  /  ENUMERATION_CONST  /  CHAR_CONST  /  '--'  /  '-'  /  '++'  /  '+'  /  '*'  /  '('  /  '&'  /  '!') EatToken)*
Err_050         <-  (!('}'  /  ']'  /  ';'  /  ':'  /  ','  /  ')') EatToken)*
Err_051         <-  (!('}'  /  '||'  /  ']'  /  '?'  /  ';'  /  ':'  /  ','  /  ')') EatToken)*
Err_052         <-  (!('}'  /  '||'  /  ']'  /  '?'  /  ';'  /  ':'  /  ','  /  ')'  /  '&&') EatToken)*
Err_053         <-  (!('}'  /  '||'  /  '|'  /  ']'  /  '?'  /  ';'  /  ':'  /  ','  /  ')'  /  '&&') EatToken)*
...
type_spec       <-  'void'_unique  /  'char'_unique  /  'short'_unique  /  'int'_unique  /  'long'_unique  /  'float'_unique  /  'double'_unique  /  'signed'_unique  /  'unsigned'_unique  /  typedef_name  /  ('enum' ID? '{'_unique enumerator_unique^Err_002 (','_unique enumerator_unique^Err_003)*_unique '}'_unique^Err_004  /  ('enum'_unique ID_unique^Err_005  /  (struct_or_union ID? '{'_unique struct_decl_unique+_unique^Err_006 '}'_unique^Err_007  /  struct_or_union_unique ID_unique^Err_008)_unique)_unique)_unique
...
spec_qualifier  <-  type_spec  /  type_qualifier
struct_declarator <-  declarator? ':' const_exp  /  declarator
enumerator      <-  ((ID '=' const_exp_unique  /  ID_unique)_unique)^Err_009
declarator      <-  pointer? direct_declarator
direct_declarator <-  (ID  /  '(' declarator ')') ('[' const_exp? ']'  /  '(' param_type_list ')'  /  '(' id_list? ')')*
pointer         <-  '*' type_qualifier* pointer  /  '*' type_qualifier*
...
direct_abstract_declarator <-  '(' abstract_declarator ')'_unique (('['_unique const_exp_unique?_unique ']'_unique^Err_010  /  '('_unique param_type_list_unique?_unique ')'_unique^Err_011)_unique)*_unique
typedef_name    <-  ID
stat            <-  ID ':' stat  /  'case'_unique const_exp_unique^Err_012 ':'_unique^Err_013 stat_unique^Err_014  /  'default'_unique ':'_unique^Err_015 stat_unique^Err_016  /  exp? ';'  /  compound_stat  /  ('if' '('^Err_017 exp^Err_018 ')' stat 'else'_unique stat_unique^Err_019  /  ('if'_unique '('_unique^Err_020 exp_unique^Err_021 ')'_unique^Err_022 stat_unique^Err_023  /  ('switch'_unique '('_unique^Err_024 exp_unique^Err_025 ')'_unique^Err_026 stat_unique^Err_027  /  ('while'_unique '('_unique^Err_028 exp_unique^Err_029 ')'_unique^Err_030 stat_unique^Err_031  /  ('do'_unique stat_unique^Err_032 'while'_unique^Err_033 '('_unique^Err_034 exp_unique^Err_035 ')'_unique^Err_036 ';'_unique^Err_037  /  ('for'_unique '('_unique^Err_038 exp_unique?_unique ';'_unique^Err_039 exp_unique?_unique ';'_unique^Err_040 exp_unique?_unique ')'_unique^Err_041 stat_unique^Err_042  /  ('goto'_unique ID_unique^Err_043 ';'_unique^Err_044  /  ('continue'_unique ';'_unique^Err_045  /  ('break'_unique ';'_unique^Err_046  /  'return'_unique exp_unique?_unique ';'_unique^Err_047)_unique)_unique)_unique)_unique)_unique)_unique)_unique)_unique)_unique
compound_stat   <-  '{' decl* stat* '}'
exp             <-  assignment_exp (',' assignment_exp)*
assignment_exp  <-  unary_exp assignment_operator assignment_exp  /  conditional_exp
...
conditional_exp <-  logical_or_exp '?'_unique exp_unique^Err_048 ':'_unique^Err_049 conditional_exp_unique^Err_050  /  logical_or_exp
const_exp       <-  conditional_exp
logical_or_exp  <-  logical_and_exp ('||'_unique logical_and_exp_unique^Err_051)*
logical_and_exp <-  inclusive_or_exp ('&&'_unique inclusive_or_exp_unique^Err_052)*
inclusive_or_exp <-  exclusive_or_exp ('|'_unique !'|' exclusive_or_exp_unique^Err_053)*
exclusive_or_exp <-  and_exp ('^'_unique and_exp_unique^Err_054)*
and_exp         <-  equality_exp ('&' !'&' equality_exp_unique)*
equality_exp    <-  relational_exp ((('=='_unique  /  '!='_unique)_unique) relational_exp_unique^Err_055)*
relational_exp  <-  shift_exp ((('<='_unique  /  ('>='_unique  /  ('<'_unique  /  '>'_unique)_unique)_unique)_unique) shift_exp_unique^Err_056)*
shift_exp       <-  additive_exp ((('<<'_unique  /  '>>'_unique)_unique) additive_exp_unique^Err_057)*
...
cast_exp        <-  '(' type_name ')' cast_exp  /  unary_exp
unary_exp       <-  '++' unary_exp  /  '--' unary_exp  /  unary_operator cast_exp  /  'sizeof'_unique ((type_name  /  unary_exp_unique)_unique)^Err_058  /  postfix_exp
postfix_exp     <-  primary_exp ('[' exp_unique ']'_unique^Err_059  /  '(' (assignment_exp (',' assignment_exp)*)? ')'  /  '.'_unique ID_unique^Err_060  /  '->'_unique ID_unique^Err_061  /  '++'  /  '--')*
