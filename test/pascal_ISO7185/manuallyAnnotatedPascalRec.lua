...
fieldList       <-  ((fixedPart (Semi variantPart^Err_037)?  /  variantPart) Semi?)?
fixedPart       <-  varDec (Semi varDec^Err_038)*
variantPart     <-  CASE Id^Err_039 (Colon Id^Err_040)? OF^Err_041 variant^Err_042 (Semi variant^Err_043)*
variant         <-  consts Colon^Err_044 LPar^Err_045 fieldList RPar^Err_046
consts          <-  const (Comma const^Err_047)*
varDecs         <-  (VAR varDec^Err_048 Semi^Err_049 (varDec Semi^Err_050)*)?
...
assignStmt      <-  var Assign^Err_069 expr^Err_070
...
caseStmt        <-  CASE expr^Err_082 OF^Err_083 caseListElement^Err_084 (Semi caseListElement^Err_085)* Semi? END^Err_086
