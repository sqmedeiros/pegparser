...
Err_001         <-  (!('{'  /  '>'  /  ';'  /  ',') EatToken)*
Err_002         <-  (!('extends'  /  '>'  /  ',') EatToken)*
Err_003         <-  (!('>'  /  ',') EatToken)*
Err_004         <-  (!('and'  /  '>'  /  ','  /  ')') EatToken)*
Err_005         <-  (!('>'  /  ',') EatToken)*
Err_006         <-  (!('>'  /  ',') EatToken)*
Err_007         <-  (!(';'  /  '.') EatToken)*
Err_008         <-  (!(';'  /  '.') EatToken)*
...
Err_010         <-  (!(';'  /  '.') EatToken)*
Err_011         <-  (!';' EatToken)*
Err_012         <-  (!('strictfp'  /  'static'  /  'public'  /  'protected'  /  'private'  /  'interface'  /  'import'  /  'final'  /  'enum'  /  'class'  /  'abstract'  /  '@'  /  ';'  /  !.) EatToken)*
Err_013         <-  (!('{'  /  'implements'  /  'extends'  /  '<') EatToken)*
Err_014         <-  (!('}'  /  '{'  /  'while'  /  'volatile'  /  'void'  /  'try'  /  'transient'  /  'throw'  /  'this'  /  'synchronized'  /  'switch'  /  'super'  /  'strictfp'  /  'stictfp'  /  'static'  /  'short'  /  'return'  /  'public'  /  'protected'  /  'private'  /  'new'  /  'native'  /  'long'  /  'interface'  /  'int'  /  'if'  /  'for'  /  'float'  /  'final'  /  'enum'  /  'double'  /  'do'  /  'default'  /  'continue'  /  'class'  /  'char'  /  'case'  /  'byte'  /  'break'  /  'boolean'  /  'assert'  /  'abstract'  /  Literal  /  Identifier  /  '@'  /  '<'  /  ';'  /  '--'  /  '++'  /  '('  /  !.) EatToken)*
Err_015         <-  (!('{'  /  'void'  /  'short'  /  'long'  /  'int'  /  'implements'  /  'float'  /  'extends'  /  'double'  /  'char'  /  'byte'  /  'boolean'  /  Identifier  /  '@') EatToken)*
Err_016         <-  (!('>'  /  ',') EatToken)*
Err_017         <-  (!('{'  /  'implements') EatToken)*
Err_018         <-  (!'{' EatToken)*
Err_019         <-  (!('{'  /  ',') EatToken)*
Err_020         <-  (!('{'  /  ',') EatToken)*
Err_021         <-  (!('}'  /  '{'  /  'while'  /  'volatile'  /  'void'  /  'try'  /  'transient'  /  'throw'  /  'this'  /  'synchronized'  /  'switch'  /  'super'  /  'strictfp'  /  'stictfp'  /  'static'  /  'short'  /  'return'  /  'query'  /  'public'  /  'protected'  /  'private'  /  'new'  /  'native'  /  'long'  /  'interface'  /  'int'  /  'instanceof'  /  'if'  /  'for'  /  'float'  /  'final'  /  'enum'  /  'double'  /  'do'  /  'default'  /  'continue'  /  'class'  /  'char'  /  'case'  /  'byte'  /  'break'  /  'boolean'  /  'assert'  /  'abstract'  /  Literal  /  InfixOperator  /  Identifier  /  AssignmentOperator  /  ']'  /  '['  /  '@'  /  '<'  /  ';'  /  '::'  /  ':'  /  '.'  /  '--'  /  ','  /  '++'  /  ')'  /  '('  /  !.) EatToken)*
Err_022         <-  (!(','  /  ')') EatToken)*
Err_023         <-  (!('{'  /  ';') EatToken)*
Err_024         <-  (!('{'  /  ';'  /  ',') EatToken)*
Err_025         <-  (!('{'  /  ';'  /  ',') EatToken)*
...
Err_029         <-  (!('short'  /  'long'  /  'int'  /  'float'  /  'final'  /  'double'  /  'char'  /  'byte'  /  'boolean'  /  Identifier  /  '@'  /  ')') EatToken)*
Err_030         <-  (!('{'  /  'throws') EatToken)*
Err_031         <-  (!('}'  /  '{'  /  'while'  /  'void'  /  'try'  /  'throw'  /  'this'  /  'synchronized'  /  'switch'  /  'super'  /  'strictfp'  /  'static'  /  'short'  /  'return'  /  'public'  /  'protected'  /  'private'  /  'new'  /  'long'  /  'int'  /  'if'  /  'for'  /  'float'  /  'final'  /  'enum'  /  'double'  /  'do'  /  'continue'  /  'class'  /  'char'  /  'byte'  /  'break'  /  'boolean'  /  'assert'  /  'abstract'  /  Literal  /  Identifier  /  '@'  /  '<'  /  ';'  /  '--'  /  '++'  /  '(') EatToken)*
...
Err_035         <-  (!';' EatToken)*
Err_036         <-  (!('}'  /  '{'  /  'while'  /  'void'  /  'try'  /  'throw'  /  'this'  /  'synchronized'  /  'switch'  /  'super'  /  'strictfp'  /  'static'  /  'short'  /  'return'  /  'public'  /  'protected'  /  'private'  /  'new'  /  'long'  /  'int'  /  'if'  /  'for'  /  'float'  /  'final'  /  'enum'  /  'double'  /  'do'  /  'continue'  /  'class'  /  'char'  /  'byte'  /  'break'  /  'boolean'  /  'assert'  /  'abstract'  /  Literal  /  Identifier  /  '@'  /  ';'  /  '--'  /  '++'  /  '(') EatToken)*
Err_037         <-  (!('{'  /  'implements') EatToken)*
Err_038         <-  (!('}'  /  '{'  /  'while'  /  'volatile'  /  'void'  /  'try'  /  'transient'  /  'throw'  /  'this'  /  'synchronized'  /  'switch'  /  'super'  /  'strictfp'  /  'stictfp'  /  'static'  /  'short'  /  'return'  /  'public'  /  'protected'  /  'private'  /  'new'  /  'native'  /  'long'  /  'interface'  /  'int'  /  'if'  /  'for'  /  'float'  /  'final'  /  'enum'  /  'double'  /  'do'  /  'default'  /  'continue'  /  'class'  /  'char'  /  'case'  /  'byte'  /  'break'  /  'boolean'  /  'assert'  /  'abstract'  /  Literal  /  Identifier  /  '@'  /  '<'  /  ';'  /  '--'  /  '++'  /  '('  /  !.) EatToken)*
Err_039         <-  (!('}'  /  Identifier  /  '@'  /  ';'  /  ',') EatToken)*
Err_040         <-  (!('}'  /  '{'  /  'while'  /  'volatile'  /  'void'  /  'try'  /  'transient'  /  'throw'  /  'this'  /  'synchronized'  /  'switch'  /  'super'  /  'strictfp'  /  'stictfp'  /  'static'  /  'short'  /  'return'  /  'public'  /  'protected'  /  'private'  /  'new'  /  'native'  /  'long'  /  'interface'  /  'int'  /  'if'  /  'for'  /  'float'  /  'final'  /  'enum'  /  'double'  /  'do'  /  'default'  /  'continue'  /  'class'  /  'char'  /  'case'  /  'byte'  /  'break'  /  'boolean'  /  'assert'  /  'abstract'  /  Literal  /  Identifier  /  '@'  /  '<'  /  ';'  /  '--'  /  '++'  /  '('  /  !.) EatToken)*
Err_041         <-  (!('{'  /  'extends'  /  '<') EatToken)*
Err_042         <-  (!('}'  /  '{'  /  'volatile'  /  'void'  /  'transient'  /  'synchronized'  /  'strictfp'  /  'stictfp'  /  'static'  /  'short'  /  'public'  /  'protected'  /  'private'  /  'native'  /  'long'  /  'interface'  /  'int'  /  'float'  /  'final'  /  'enum'  /  'double'  /  'default'  /  'class'  /  'char'  /  'byte'  /  'boolean'  /  'abstract'  /  Identifier  /  '@'  /  '<'  /  ';'  /  !.) EatToken)*
Err_043         <-  (!'{' EatToken)*
Err_044         <-  (!('}'  /  'void'  /  'strictfp'  /  'static'  /  'short'  /  'public'  /  'protected'  /  'private'  /  'long'  /  'interface'  /  'int'  /  'float'  /  'final'  /  'enum'  /  'double'  /  'default'  /  'class'  /  'char'  /  'byte'  /  'boolean'  /  'abstract'  /  Identifier  /  '@'  /  '<'  /  ';') EatToken)*
Err_045         <-  (!('}'  /  '{'  /  'volatile'  /  'void'  /  'transient'  /  'synchronized'  /  'strictfp'  /  'stictfp'  /  'static'  /  'short'  /  'public'  /  'protected'  /  'private'  /  'native'  /  'long'  /  'interface'  /  'int'  /  'float'  /  'final'  /  'enum'  /  'double'  /  'default'  /  'class'  /  'char'  /  'byte'  /  'boolean'  /  'abstract'  /  Identifier  /  '@'  /  '<'  /  ';'  /  !.) EatToken)*
Err_046         <-  (!'{' EatToken)*
Err_047         <-  (!('}'  /  '{'  /  'volatile'  /  'void'  /  'transient'  /  'synchronized'  /  'strictfp'  /  'stictfp'  /  'static'  /  'short'  /  'public'  /  'protected'  /  'private'  /  'native'  /  'long'  /  'interface'  /  'int'  /  'float'  /  'final'  /  'enum'  /  'double'  /  'default'  /  'class'  /  'char'  /  'byte'  /  'boolean'  /  'abstract'  /  Identifier  /  '@'  /  '<'  /  ';'  /  !.) EatToken)*
Err_048         <-  (!('}'  /  'strictfp'  /  'static'  /  'short'  /  'public'  /  'protected'  /  'private'  /  'long'  /  'interface'  /  'int'  /  'float'  /  'final'  /  'enum'  /  'double'  /  'class'  /  'char'  /  'byte'  /  'boolean'  /  'abstract'  /  Identifier  /  '@'  /  ';') EatToken)*
...
Err_050         <-  (!('{'  /  'while'  /  'void'  /  'try'  /  'throw'  /  'this'  /  'synchronized'  /  'switch'  /  'super'  /  'short'  /  'return'  /  'new'  /  'long'  /  'int'  /  'if'  /  'for'  /  'float'  /  'double'  /  'do'  /  'continue'  /  'char'  /  'byte'  /  'break'  /  'boolean'  /  'assert'  /  Literal  /  Identifier  /  '@'  /  ';'  /  '--'  /  '++'  /  '(') EatToken)*
...
Err_053         <-  (!('{'  /  'while'  /  'void'  /  'try'  /  'throw'  /  'this'  /  'synchronized'  /  'switch'  /  'super'  /  'short'  /  'return'  /  'new'  /  'long'  /  'int'  /  'if'  /  'for'  /  'float'  /  'double'  /  'do'  /  'continue'  /  'char'  /  'byte'  /  'break'  /  'boolean'  /  'assert'  /  Literal  /  Identifier  /  '@'  /  ';'  /  '--'  /  '++'  /  '(') EatToken)*
...
Err_061         <-  (!('}'  /  '{'  /  'while'  /  'void'  /  'try'  /  'throw'  /  'this'  /  'synchronized'  /  'switch'  /  'super'  /  'strictfp'  /  'static'  /  'short'  /  'return'  /  'public'  /  'protected'  /  'private'  /  'new'  /  'long'  /  'int'  /  'if'  /  'for'  /  'float'  /  'final'  /  'enum'  /  'else'  /  'double'  /  'do'  /  'default'  /  'continue'  /  'class'  /  'char'  /  'case'  /  'byte'  /  'break'  /  'boolean'  /  'assert'  /  'abstract'  /  Literal  /  Identifier  /  '@'  /  ';'  /  '--'  /  '++'  /  '(') EatToken)*
...
Err_066         <-  (!('}'  /  '{'  /  'while'  /  'void'  /  'try'  /  'throw'  /  'this'  /  'synchronized'  /  'switch'  /  'super'  /  'strictfp'  /  'static'  /  'short'  /  'return'  /  'public'  /  'protected'  /  'private'  /  'new'  /  'long'  /  'int'  /  'if'  /  'for'  /  'float'  /  'final'  /  'enum'  /  'else'  /  'double'  /  'do'  /  'default'  /  'continue'  /  'class'  /  'char'  /  'case'  /  'byte'  /  'break'  /  'boolean'  /  'assert'  /  'abstract'  /  Literal  /  Identifier  /  '@'  /  ';'  /  '--'  /  '++'  /  '(') EatToken)*
Err_067         <-  (!(';'  /  ':') EatToken)*
Err_068         <-  (!';' EatToken)*
...
Err_072         <-  (!':' EatToken)*
Err_073         <-  (!('}'  /  '{'  /  'while'  /  'void'  /  'try'  /  'throw'  /  'this'  /  'synchronized'  /  'switch'  /  'super'  /  'strictfp'  /  'static'  /  'short'  /  'return'  /  'public'  /  'protected'  /  'private'  /  'new'  /  'long'  /  'int'  /  'if'  /  'for'  /  'float'  /  'final'  /  'enum'  /  'double'  /  'do'  /  'default'  /  'continue'  /  'class'  /  'char'  /  'case'  /  'byte'  /  'break'  /  'boolean'  /  'assert'  /  'abstract'  /  Literal  /  Identifier  /  '@'  /  ';'  /  '--'  /  '++'  /  '(') EatToken)*
Err_074         <-  (!':' EatToken)*
Err_075         <-  (!('void'  /  'this'  /  'super'  /  'short'  /  'new'  /  'long'  /  'int'  /  'float'  /  'final'  /  'double'  /  'char'  /  'byte'  /  'boolean'  /  Literal  /  Identifier  /  '@'  /  ';'  /  '--'  /  '++'  /  '(') EatToken)*
Err_076         <-  (!('void'  /  'this'  /  'super'  /  'short'  /  'new'  /  'long'  /  'int'  /  'float'  /  'double'  /  'char'  /  'byte'  /  'boolean'  /  Literal  /  Identifier  /  '@'  /  '--'  /  '++'  /  ')'  /  '(') EatToken)*
Err_077         <-  (!('{'  /  'while'  /  'void'  /  'try'  /  'throw'  /  'this'  /  'synchronized'  /  'switch'  /  'super'  /  'short'  /  'return'  /  'new'  /  'long'  /  'int'  /  'if'  /  'for'  /  'float'  /  'double'  /  'do'  /  'continue'  /  'char'  /  'byte'  /  'break'  /  'boolean'  /  'assert'  /  Literal  /  Identifier  /  '@'  /  ';'  /  '--'  /  '++'  /  '(') EatToken)*
...
Err_079         <-  (!('short'  /  'long'  /  'int'  /  'float'  /  'final'  /  'double'  /  'char'  /  'byte'  /  'boolean'  /  Identifier  /  '@') EatToken)*
Err_080         <-  (!('}'  /  '{'  /  'while'  /  'void'  /  'try'  /  'throw'  /  'this'  /  'synchronized'  /  'switch'  /  'super'  /  'strictfp'  /  'static'  /  'short'  /  'return'  /  'public'  /  'protected'  /  'private'  /  'new'  /  'long'  /  'int'  /  'if'  /  'for'  /  'float'  /  'final'  /  'enum'  /  'else'  /  'double'  /  'do'  /  'default'  /  'continue'  /  'class'  /  'char'  /  'case'  /  'byte'  /  'break'  /  'boolean'  /  'assert'  /  'abstract'  /  Literal  /  Identifier  /  '@'  /  ';'  /  '--'  /  '++'  /  '(') EatToken)*
Err_081         <-  (!('}'  /  '{'  /  'while'  /  'void'  /  'try'  /  'throw'  /  'this'  /  'synchronized'  /  'switch'  /  'super'  /  'strictfp'  /  'static'  /  'short'  /  'return'  /  'public'  /  'protected'  /  'private'  /  'new'  /  'long'  /  'int'  /  'if'  /  'for'  /  'float'  /  'finally'  /  'final'  /  'enum'  /  'else'  /  'double'  /  'do'  /  'default'  /  'continue'  /  'class'  /  'char'  /  'catch'  /  'case'  /  'byte'  /  'break'  /  'boolean'  /  'assert'  /  'abstract'  /  Literal  /  Identifier  /  '@'  /  ';'  /  '--'  /  '++'  /  '(') EatToken)*
...
Err_083         <-  (!('final'  /  Identifier  /  '@') EatToken)*
Err_084         <-  (!')' EatToken)*
Err_085         <-  (!'{' EatToken)*
Err_086         <-  (!('}'  /  '{'  /  'while'  /  'void'  /  'try'  /  'throw'  /  'this'  /  'synchronized'  /  'switch'  /  'super'  /  'strictfp'  /  'static'  /  'short'  /  'return'  /  'public'  /  'protected'  /  'private'  /  'new'  /  'long'  /  'int'  /  'if'  /  'for'  /  'float'  /  'finally'  /  'final'  /  'enum'  /  'else'  /  'double'  /  'do'  /  'default'  /  'continue'  /  'class'  /  'char'  /  'catch'  /  'case'  /  'byte'  /  'break'  /  'boolean'  /  'assert'  /  'abstract'  /  Literal  /  Identifier  /  '@'  /  ';'  /  '--'  /  '++'  /  '(') EatToken)*
Err_087         <-  (!Identifier EatToken)*
Err_088         <-  (!')' EatToken)*
Err_089         <-  (!('|'  /  Identifier) EatToken)*
...
Err_095         <-  (!(';'  /  ','  /  ')') EatToken)*
Err_096         <-  (!(';'  /  ','  /  ')') EatToken)*
Err_097         <-  (!Identifier EatToken)*
Err_098         <-  (!'=' EatToken)*
Err_099         <-  (!('~'  /  'void'  /  'this'  /  'super'  /  'short'  /  'new'  /  'long'  /  'int'  /  'float'  /  'double'  /  'char'  /  'byte'  /  'boolean'  /  Literal  /  Identifier  /  '@'  /  '--'  /  '-'  /  '++'  /  '+'  /  '('  /  '!') EatToken)*
Err_100         <-  (!(';'  /  ','  /  ')') EatToken)*
Err_101         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  AssignmentOperator  /  ']'  /  '['  /  ';'  /  '::'  /  ':'  /  '.'  /  '--'  /  ','  /  '++'  /  ')') EatToken)*
Err_102         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  AssignmentOperator  /  ']'  /  '['  /  ';'  /  '::'  /  ':'  /  '.'  /  '--'  /  ','  /  '++'  /  ')') EatToken)*
Err_103         <-  (!'(' EatToken)*
Err_104         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  AssignmentOperator  /  ']'  /  '['  /  ';'  /  '::'  /  ':'  /  '.'  /  '--'  /  ','  /  '++'  /  ')') EatToken)*
Err_105         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  AssignmentOperator  /  ']'  /  '['  /  ';'  /  '::'  /  ':'  /  '.'  /  '--'  /  ','  /  '++'  /  ')') EatToken)*
Err_106         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  AssignmentOperator  /  ']'  /  '['  /  ';'  /  '::'  /  ':'  /  '.'  /  '--'  /  ','  /  '++'  /  ')') EatToken)*
Err_107         <-  (!('}'  /  '{'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  AssignmentOperator  /  ']'  /  '['  /  ';'  /  '::'  /  ':'  /  '.'  /  '--'  /  ','  /  '++'  /  ')') EatToken)*
Err_108         <-  (!('<'  /  '.'  /  '(') EatToken)*
Err_109         <-  (!('<'  /  '.'  /  '(') EatToken)*
Err_110         <-  (!('.'  /  '(') EatToken)*
Err_111         <-  (!('{'  /  '['  /  '@') EatToken)*
Err_112         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  AssignmentOperator  /  ']'  /  '['  /  ';'  /  '::'  /  ':'  /  '.'  /  '--'  /  ','  /  '++'  /  ')') EatToken)*
Err_113         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  AssignmentOperator  /  ']'  /  '['  /  ';'  /  '::'  /  ':'  /  '.'  /  '--'  /  ','  /  '++'  /  ')') EatToken)*
Err_114         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  ']'  /  ';'  /  ':'  /  ','  /  ')') EatToken)*
Err_115         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  ']'  /  ';'  /  ':'  /  ','  /  ')') EatToken)*
Err_116         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  ']'  /  ';'  /  ':'  /  ','  /  ')') EatToken)*
Err_117         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  ']'  /  ';'  /  ':'  /  ','  /  ')') EatToken)*
Err_118         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  ']'  /  ';'  /  ':'  /  ','  /  ')') EatToken)*
Err_119         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  ']'  /  ';'  /  ':'  /  ','  /  ')') EatToken)*
Err_120         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  ']'  /  ';'  /  ':'  /  ','  /  ')') EatToken)*
Err_121         <-  (!':' EatToken)*
Err_122         <-  (!('~'  /  'void'  /  'this'  /  'super'  /  'short'  /  'new'  /  'long'  /  'int'  /  'float'  /  'double'  /  'char'  /  'byte'  /  'boolean'  /  Literal  /  Identifier  /  '@'  /  '--'  /  '-'  /  '++'  /  '+'  /  '('  /  '!') EatToken)*
Err_123         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  ']'  /  ';'  /  ':'  /  ','  /  ')') EatToken)*
Err_124         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  ']'  /  ';'  /  ':'  /  ','  /  ')') EatToken)*
Err_125         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  ']'  /  ';'  /  ':'  /  ','  /  ')') EatToken)*
Err_126         <-  (!('}'  /  'query'  /  'instanceof'  /  InfixOperator  /  Identifier  /  ']'  /  ';'  /  ':'  /  ','  /  ')') EatToken)*	
...
arrayType       <-  primitiveType dim+  /  classType dim+
typeVariable    <-  annotation_unique*_unique Identifier_unique^Err_001
dim             <-  annotation* '[' ']'
typeParameter   <-  typeParameterModifier_unique*_unique Identifier_unique^Err_002 typeBound_unique?_unique
typeParameterModifier <-  annotation_unique
typeBound       <-  'extends'_unique ((classType additionalBound*  /  typeVariable_unique)_unique)^Err_003
additionalBound <-  'and'_unique classType_unique^Err_004
typeArguments   <-  '<' typeArgumentList '>'
typeArgumentList <-  typeArgument (',' typeArgument)*
typeArgument    <-  referenceType  /  wildcard_unique
wildcard        <-  annotation* '?'_unique wildcardBounds_unique?_unique
wildcardBounds  <-  ('extends'_unique referenceType_unique^Err_005  /  'super'_unique referenceType_unique^Err_006)_unique
qualIdent       <-  Identifier ('.' Identifier)*
compilationUnit <-  packageDeclaration_unique?_unique importDeclaration*_unique typeDeclaration_unique*_unique
packageDeclaration <-  packageModifier* 'package'_unique Identifier_unique^Err_007 ('.'_unique Identifier_unique^Err_008)*_unique ';'_unique^Err_009
packageModifier <-  annotation
importDeclaration <-  'import'_unique 'static'_unique?_unique qualIdent_unique^Err_010 ('.'_unique '*'_unique^Err_011)?_unique ';'_unique^Err_012  /  ';'
...
normalClassDeclaration <-  classModifier* 'class'_unique Identifier_unique^Err_013 typeParameters_unique?_unique superclass_unique?_unique superinterfaces_unique?_unique classBody_unique^Err_014
classModifier   <-  annotation  /  'public'  /  'protected'  /  'private'  /  'abstract'  /  'static'  /  'final'  /  'strictfp'
typeParameters  <-  '<' typeParameterList_unique '>'_unique^Err_015
typeParameterList <-  typeParameter_unique (','_unique typeParameter_unique^Err_016)*_unique
superclass      <-  'extends'_unique classType_unique^Err_017
superinterfaces <-  'implements'_unique interfaceTypeList_unique^Err_018
interfaceTypeList <-  classType_unique^Err_019 (','_unique classType_unique^Err_020)*_unique
classBody       <-  '{'_unique classBodyDeclaration_unique*_unique '}'_unique^Err_021
...
methodDeclarator <-  Identifier '(' formalParameterList? ')' dim*
formalParameterList <-  (receiverParameter  /  formalParameter) (',' formalParameter)*
formalParameter <-  variableModifier* unannType variableDeclaratorId  /  variableModifier* unannType annotation* '...'_unique variableDeclaratorId_unique^Err_022 !','
variableModifier <-  annotation  /  'final'
receiverParameter <-  variableModifier* unannType (Identifier '.')? 'this'
result          <-  unannType  /  'void'
...
throws          <-  'throws'_unique exceptionTypeList_unique^Err_023
exceptionTypeList <-  exceptionType_unique^Err_024 (','_unique exceptionType_unique^Err_025)*_unique
exceptionType   <-  ((classType  /  typeVariable_unique)_unique)^Err_026
methodBody      <-  block  /  ';'
instanceInitializer <-  block_unique
staticInitializer <-  'static'_unique block_unique^Err_027
constructorDeclaration <-  constructorModifier_unique*_unique constructorDeclarator_unique throws_unique?_unique constructorBody_unique^Err_028
constructorDeclarator <-  typeParameters_unique?_unique Identifier_unique '('_unique^Err_029 formalParameterList_unique?_unique ')'_unique^Err_030
constructorModifier <-  (annotation_unique  /  ('public'_unique  /  ('protected'_unique  /  'private'_unique)_unique)_unique)_unique
constructorBody <-  '{'_unique^Err_031 explicitConstructorInvocation?_unique blockStatements_unique?_unique '}'_unique^Err_032
explicitConstructorInvocation <-  typeArguments? 'this'_unique arguments_unique^Err_033 ';'_unique^Err_034  /  typeArguments? 'super'_unique arguments_unique^Err_035 ';'_unique^Err_036  /  primary '.' typeArguments? 'super' arguments ';'  /  qualIdent '.' typeArguments? 'super' arguments ';'
enumDeclaration <-  classModifier* 'enum'_unique Identifier_unique^Err_037 superinterfaces_unique?_unique enumBody_unique^Err_038
enumBody        <-  '{'_unique^Err_039 enumConstantList_unique?_unique ','_unique?_unique enumBodyDeclarations_unique?_unique '}'_unique^Err_040
...
normalInterfaceDeclaration <-  interfaceModifier* 'interface'_unique Identifier_unique^Err_041 typeParameters_unique?_unique extendsInterfaces_unique?_unique interfaceBody_unique^Err_042
interfaceModifier <-  annotation  /  'public'  /  'protected'  /  'private'  /  'abstract'  /  'static'  /  'strictfp'
extendsInterfaces <-  'extends'_unique interfaceTypeList_unique^Err_043
interfaceBody   <-  '{'_unique^Err_044 interfaceMemberDeclaration_unique*_unique '}'_unique^Err_045
...
interfaceMethodDeclaration <-  interfaceMethodModifier* methodHeader methodBody
interfaceMethodModifier <-  annotation  /  'public'  /  'abstract'  /  'default'  /  'static'  /  'strictfp'
annotationTypeDeclaration <-  interfaceModifier* '@' 'interface'_unique Identifier_unique^Err_046 annotationTypeBody_unique^Err_047
annotationTypeBody <-  '{'_unique^Err_048 annotationTypeMemberDeclaration_unique*_unique '}'_unique^Err_049
...
localVariableDeclarationStatement <-  localVariableDeclaration ';'
localVariableDeclaration <-  variableModifier* unannType variableDeclaratorList
statement       <-  block  /  'if'_unique parExpression_unique^Err_050 statement_unique^Err_051 ('else'_unique statement_unique^Err_052)?_unique  /  basicForStatement_unique  /  enhancedForStatement  /  'while'_unique parExpression_unique^Err_053 statement_unique^Err_054  /  'do'_unique statement_unique^Err_055 'while'_unique^Err_056 parExpression_unique^Err_057 ';'_unique^Err_058  /  tryStatement_unique  /  'switch'_unique parExpression_unique^Err_059 switchBlock_unique^Err_060  /  'synchronized' parExpression_unique block_unique^Err_061  /  'return'_unique expression_unique?_unique ';'_unique^Err_062  /  'throw'_unique expression_unique^Err_063 ';'_unique^Err_064  /  'break'_unique Identifier_unique?_unique ';'_unique^Err_065  /  'continue'_unique Identifier_unique?_unique ';'_unique^Err_066  /  'assert'_unique expression_unique^Err_067 (':'_unique expression_unique^Err_068)?_unique ';'_unique^Err_069  /  ';'  /  statementExpression ';'  /  Identifier ':' statement
statementExpression <-  assignment  /  ('++'  /  '--') (primary  /  qualIdent)  /  (primary  /  qualIdent) ('++'  /  '--')  /  primary
switchBlock     <-  '{'_unique^Err_070 switchBlockStatementGroup*_unique switchLabel_unique*_unique '}'_unique^Err_071
switchBlockStatementGroup <-  switchLabels blockStatements
switchLabels    <-  switchLabel switchLabel*
switchLabel     <-  ('case'_unique ((constantExpression  /  enumConstantName_unique)_unique)^Err_072 ':'_unique^Err_073  /  'default' ':'_unique)_unique
enumConstantName <-  Identifier_unique^Err_074
basicForStatement <-  'for' '('^Err_075 forInit? ';'_unique expression_unique?_unique ';'_unique^Err_076 forUpdate_unique?_unique ')'_unique^Err_077 statement_unique^Err_078
forInit         <-  localVariableDeclaration  /  statementExpressionList
forUpdate       <-  statementExpressionList_unique
statementExpressionList <-  statementExpression (',' statementExpression)*
enhancedForStatement <-  'for' '('^Err_079 variableModifier* unannType variableDeclaratorId ':' expression ')' statement
tryStatement    <-  'try'_unique ((block_unique ((catchClause_unique* finally_unique  /  catchClause_unique+_unique)_unique)^Err_080  /  resourceSpecification_unique block_unique^Err_081 catchClause_unique*_unique finally_unique?_unique)_unique)^Err_082
catchClause     <-  'catch'_unique '('_unique^Err_083 catchFormalParameter_unique^Err_084 ')'_unique^Err_085 block_unique^Err_086
catchFormalParameter <-  variableModifier_unique*_unique catchType_unique^Err_087 variableDeclaratorId_unique^Err_088
catchType       <-  unannClassType_unique^Err_089 ('|'_unique ![=|] classType_unique^Err_090)*_unique
finally         <-  'finally'_unique block_unique^Err_091
resourceSpecification <-  '('_unique^Err_092 resourceList_unique^Err_093 ';'_unique?_unique ')'_unique^Err_094
resourceList    <-  resource_unique^Err_095 (','_unique resource_unique^Err_096)*_unique
resource        <-  variableModifier_unique*_unique unannType_unique^Err_097 variableDeclaratorId_unique^Err_098 '='_unique^Err_099 !'=' expression_unique^Err_100
expression      <-  lambdaExpression  /  assignmentExpression
primary         <-  primaryBase primaryRest*
primaryBase     <-  'this'  /  Literal_unique  /  parExpression  /  'super' (('.' typeArguments? Identifier arguments  /  '.' Identifier  /  '::' typeArguments? Identifier)_unique)  /  'new'_unique ((classCreator  /  arrayCreator_unique)_unique)^Err_101  /  qualIdent ('[' expression ']'  /  arguments  /  '.' ('this'  /  'new' classCreator^Err_102  /  typeArguments Identifier arguments  /  'super' '.' typeArguments? Identifier arguments  /  'super' '.' Identifier  /  'super' '::'_unique typeArguments_unique?_unique Identifier_unique^Err_103 arguments_unique^Err_104)  /  ('[' ']')* '.' 'class'  /  '::' typeArguments? Identifier)  /  'void' '.'_unique 'class'_unique^Err_105  /  basicType ('[' ']')* '.' 'class'  /  referenceType '::' typeArguments? 'new'_unique  /  arrayType '::' 'new'
primaryRest     <-  '.' (typeArguments? Identifier arguments  /  Identifier  /  'new' classCreator^Err_106)  /  '[' expression ']'  /  '::' typeArguments? Identifier
parExpression   <-  '(' expression ')'
classCreator    <-  typeArguments_unique? annotation*_unique classTypeWithDiamond_unique arguments_unique^Err_107 classBody_unique?_unique
classTypeWithDiamond <-  annotation_unique*_unique Identifier_unique^Err_108 typeArgumentsOrDiamond_unique?_unique ('.'_unique annotation_unique*_unique Identifier_unique^Err_109 typeArgumentsOrDiamond_unique?_unique)*_unique
typeArgumentsOrDiamond <-  (typeArguments  /  '<'_unique '>'_unique^Err_110 !'.')_unique
arrayCreator    <-  ((type dimExpr+ dim*  /  type_unique dim_unique+_unique^Err_111 arrayInitializer_unique^Err_112)_unique)^Err_113
dimExpr         <-  annotation* '[' expression ']'
arguments       <-  '(' argumentList? ')'
argumentList    <-  expression (',' expression)*
unaryExpression <-  ('++'  /  '--') (primary  /  qualIdent)  /  '+'_unique ![=+] unaryExpression_unique^Err_114  /  '-'_unique ![-=>] unaryExpression_unique^Err_115  /  unaryExpressionNotPlusMinus
unaryExpressionNotPlusMinus <-  '~'_unique unaryExpression_unique^Err_116  /  '!'_unique ![=&] unaryExpression_unique^Err_117  /  castExpression  /  (primary  /  qualIdent) ('++'  /  '--')?
castExpression  <-  '(' primitiveType ')'_unique unaryExpression_unique^Err_118  /  '(' referenceType additionalBound* ')' lambdaExpression  /  '(' referenceType additionalBound* ')' unaryExpressionNotPlusMinus
infixExpression <-  unaryExpression ((InfixOperator_unique unaryExpression_unique^Err_119  /  'instanceof'_unique referenceType_unique^Err_120)_unique)*
InfixOperator   <-  '||'  /  '&&'  /  '|' ![=|]  /  '^' ![=]  /  '&' ![=&]  /  '=='  /  '!='  /  '<' ![=<]  /  '>' ![=>]  /  '<='  /  '>='  /  '<<' ![=]  /  '>>' ![=>]  /  '>>>' ![=]  /  '+' ![=+]  /  '-' ![-=>]  /  '*' ![=]  /  '/' ![=]  /  '%' ![=]
conditionalExpression <-  infixExpression ('query'_unique expression_unique^Err_121 ':'_unique^Err_122 expression_unique^Err_123)*
assignmentExpression <-  assignment  /  conditionalExpression
assignment      <-  leftHandSide AssignmentOperator_unique expression_unique^Err_124
leftHandSide    <-  primary  /  qualIdent
AssignmentOperator <-  '=' ![=]  /  '*='  /  '/='  /  '%='  /  '+='  /  '-='  /  '<<='  /  '>>='  /  '>>>='  /  '&='  /  '^='  /  '|='
lambdaExpression <-  lambdaParameters '->'_unique lambdaBody_unique^Err_125
lambdaParameters <-  Identifier  /  '(' formalParameterList? ')'  /  '(' inferredFormalParameterList ')'
inferredFormalParameterList <-  Identifier (',' Identifier)*
lambdaBody      <-  ((expression_unique  /  block_unique)_unique)^Err_126
constantExpression <-  expression
Identifier      <-  !Keywords [a-zA-Z_] [a-zA-Z_$0-9]*
Keywords        <-  ('abstract'  /  'assert'  /  'boolean'  /  'break'  /  'byte'  /  'case'  /  'catch'  /  'char'  /  'class'  /  'const'  /  'continue'  /  'default'  /  'double'  /  'do'  /  'else'  /  'enum'  /  'extends'  /  'false'  /  'finally'  /  'final'  /  'float'  /  'for'  /  'goto'  /  'if'  /  'implements'  /  'import'  /  'interface'  /  'int'  /  'instanceof'  /  'long'  /  'native'  /  'new'  /  'null'  /  'package'  /  'private'  /  'protected'  /  'public'  /  'return'  /  'short'  /  'static'  /  'strictfp'  /  'super'  /  'switch'  /  'synchronized'  /  'this'  /  'throws'  /  'throw'  /  'transient'  /  'true'  /  'try'  /  'void'  /  'volatile'  /  'while') ![a-zA-Z_$0-9]
Literal         <-  FloatLiteral  /  IntegerLiteral  /  BooleanLiteral  /  CharLiteral  /  StringLiteral  /  NullLiteral
