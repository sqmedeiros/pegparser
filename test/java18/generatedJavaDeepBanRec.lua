...
-- Labels from DeepBan united with labels from UPath
--[[
	Replaced:
		Err_064 -> Err_063
		Err_065 -> Err_063
...
typeBound       <-  'extends' (classType additionalBound*  /  typeVariable)^Deep_001
...
superclass      <-  'extends' classType^Deep_004
superinterfaces <-  'implements' interfaceTypeList^Err_010
interfaceTypeList <-  classType (',' classType^Deep_006)*
...
extendsInterfaces <-  'extends' interfaceTypeList^Deep_009
...
defaultValue    <-  'default' elementValue^Deep_010
...
statementExpressionList <-  statementExpression (',' statementExpression^Deep_011)*
...
typeArgumentsOrDiamond <-  typeArguments  /  '<' '>'Deep_012 !'.'
arrayCreator    <-  type dimExpr+ dim*  /  type dim+ arrayInitializer
dimExpr         <-  annotation* '[' expression ']'
arguments       <-  '(' argumentList? ')'
argumentList    <-  expression (',' expression^Deep_013)*
unaryExpression <-  ('++'  /  '--') (primary  /  qualIdent)  /  '+' ![=+] unaryExpression^Err_063  /  '-' ![-=>] unaryExpression^Err_063  /  unaryExpressionNotPlusMinus
unaryExpressionNotPlusMinus <-  '~' unaryExpression^Err_063  /  '!' ![=&] unaryExpression^Err_063  /  castExpression  /  (primary  /  qualIdent) ('++'  /  '--')?
...
infixExpression <-  unaryExpression (InfixOperator unaryExpression^Err_063  /  'instanceof' referenceType^Err_063)*
InfixOperator   <-  '||'  /  '&&'  /  '|' ![=|]  /  '^' ![=]  /  '&' ![=&]  /  '=='  /  '!='  /  '<' ![=<]  /  '>' ![=>]  /  '<='  /  '>='  /  '<<' ![=]  /  '>>' ![=>]  /  '>>>' ![=]  /  '+' ![=+]  /  '-' ![-=>]  /  '*' ![=]  /  '/' ![=]  /  '%' ![=]
