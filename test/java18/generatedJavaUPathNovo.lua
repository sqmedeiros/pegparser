...
switchLabel     <-  'case' (constantExpression  /  enumConstantName)^Err_034 ':'^Err_035  /  'default' ':'
...
tryStatement    <-  'try' (block (catchClause* finally  /  catchClause+)^Err_036  /  resourceSpecification block^Err_037 catchClause* finally?)^Err_038
catchClause     <-  'catch' '('^Err_039 catchFormalParameter^Err_040 ')'^Err_041 block^Err_042
catchFormalParameter <-  variableModifier* catchType variableDeclaratorId^Err_043
catchType       <-  unannClassType ('|' ![=|] classType^Err_044)*
finally         <-  'finally' block^Err_045
resourceSpecification <-  '(' resourceList^Err_046 ';'? ')'^Err_047
resourceList    <-  resource (',' resource^Err_048)*
resource        <-  variableModifier* unannType variableDeclaratorId^Err_049 '='^Err_050 !'=' expression^Err_051
...
unaryExpression <-  ('++'  /  '--') (primary  /  qualIdent)  /  '+' ![=+] unaryExpression^Err_052  /  '-' ![-=>] unaryExpression^Err_053  /  unaryExpressionNotPlusMinus
unaryExpressionNotPlusMinus <-  '~' unaryExpression^Err_054  /  '!' ![=&] unaryExpression^Err_055  /  castExpression  /  (primary  /  qualIdent) ('++'  /  '--')?
...
assignment      <-  leftHandSide AssignmentOperator expression^Err_056
leftHandSide    <-  primary  /  qualIdent
AssignmentOperator <-  '=' ![=]  /  '*='  /  '/='  /  '%='  /  '+='  /  '-='  /  '<<='  /  '>>='  /  '>>>='  /  '&='  /  '^='  /  '|='
lambdaExpression <-  lambdaParameters '->' lambdaBody^Err_057
