...
resource              <-  variableModifier* unannType variableDeclaratorId^VariableDeclaratorIdErr3 '='^Err_042 (!'=')^EqAvaliableErr3 expression^ExpressionErr5
...
lambdaParameters      <-  Identifier                          /
                          '(' formalParameterList? ')'       /
                          '(' inferredFormalParameterList^Err_055 ')'
...
ClassTypeErr        <-  (!'Identifier' EatToken)*
