...
--[=[ Gramática gerada pelo antigo algoritmo deep_ban (Hard v3)
  Inserted: 13 labels (13 correct) 
	8 labels diferentes do UPath:
		escolha na regra typeBound
		classType na regra superclass
		classType na regra interfaceTypeList
		interfaceTypeList na regra extendsInterfaces
    elementValue na regra defaultValue	
		statementExpression na regra statementExpressionList
		'>' na regra typeArgumentsOrDiamond
		expression na regra argumentList
]=]
...
superclass      <-  'extends' classType^Err_004
superinterfaces <-  'implements' interfaceTypeList^Err_005
interfaceTypeList <-  classType (',' classType^Err_006)*
...
throws          <-  'throws' exceptionTypeList^Err_007
exceptionTypeList <-  exceptionType (',' exceptionType^Err_008)*
...
extendsInterfaces <-  'extends' interfaceTypeList^Err_009
...
defaultValue    <-  'default' elementValue^Err_010
...
statementExpressionList <-  statementExpression (',' statementExpression^Err_011)*
...
typeArgumentsOrDiamond <-  typeArguments  /  '<' '>'^Err_012 !'.'
arrayCreator    <-  type dimExpr+ dim*  /  type dim+ arrayInitializer
dimExpr         <-  annotation* '[' expression ']'
arguments       <-  '(' argumentList? ')'
argumentList    <-  expression (',' expression^Err_013)*
