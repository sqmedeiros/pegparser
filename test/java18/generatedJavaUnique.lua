...
packageDeclaration <-  packageModifier* 'package' Identifier^Err_002 ('.' Identifier)* ';'^Err_003
packageModifier <-  annotation
importDeclaration <-  'import' 'static'? qualIdent^Err_004 ('.' '*')? ';'^Err_005  /  ';'
...
superinterfaces <-  'implements' interfaceTypeList^Err_006
...
formalParameter <-  variableModifier* unannType variableDeclaratorId  /  variableModifier* unannType annotation* '...' variableDeclaratorId^Err_007 !','
...
throws          <-  'throws' exceptionTypeList^Err_008
...
enumDeclaration <-  classModifier* 'enum' Identifier^Err_009 superinterfaces? enumBody^Err_010
...
statement       <-  block  /  'if' parExpression^Err_011 statement^Err_012 ('else' statement^Err_013)?  /  basicForStatement  /  enhancedForStatement  /  'while' parExpression statement  /  'do' statement^Err_014 'while'^Err_015 parExpression^Err_016 ';'^Err_017  /  tryStatement  /  'switch' parExpression^Err_018 switchBlock^Err_019  /  'synchronized' parExpression block  /  'return' expression? ';'^Err_020  /  'throw' expression^Err_021 ';'^Err_022  /  'break' Identifier? ';'^Err_023  /  'continue' Identifier? ';'^Err_024  /  'assert' expression^Err_025 (':' expression)? ';'^Err_026  /  ';'  /  statementExpression ';'  /  Identifier ':' statement
statementExpression <-  assignment  /  ('++'  /  '--') (primary  /  qualIdent)  /  (primary  /  qualIdent) ('++'  /  '--')  /  primary
switchBlock     <-  '{' switchBlockStatementGroup* switchLabel* '}'
switchBlockStatementGroup <-  switchLabels blockStatements
switchLabels    <-  switchLabel switchLabel*
switchLabel     <-  'case' (constantExpression  /  enumConstantName)^Err_027 ':'^Err_028  /  'default' ':'
...
tryStatement    <-  'try' (block (catchClause* finally  /  catchClause+)  /  resourceSpecification block catchClause* finally?)^Err_029
catchClause     <-  'catch' '('^Err_030 catchFormalParameter^Err_031 ')'^Err_032 block^Err_033
catchFormalParameter <-  variableModifier* catchType variableDeclaratorId
catchType       <-  unannClassType ('|' ![=|] classType^Err_034)*
finally         <-  'finally' block^Err_035
...
unaryExpression <-  ('++'  /  '--') (primary  /  qualIdent)  /  '+' ![=+] unaryExpression^Err_036  /  '-' ![-=>] unaryExpression^Err_037  /  unaryExpressionNotPlusMinus
unaryExpressionNotPlusMinus <-  '~' unaryExpression^Err_038  /  '!' ![=&] unaryExpression^Err_039  /  castExpression  /  (primary  /  qualIdent) ('++'  /  '--')?
...
infixExpression <-  unaryExpression (InfixOperator unaryExpression^Err_040  /  'instanceof' referenceType^Err_041)*
InfixOperator   <-  '||'  /  '&&'  /  '|' ![=|]  /  '^' ![=]  /  '&' ![=&]  /  '=='  /  '!='  /  '<' ![=<]  /  '>' ![=>]  /  '<='  /  '>='  /  '<<' ![=]  /  '>>' ![=>]  /  '>>>' ![=]  /  '+' ![=+]  /  '-' ![-=>]  /  '*' ![=]  /  '/' ![=]  /  '%' ![=]
conditionalExpression <-  infixExpression ('query' expression^Err_042 ':'^Err_043 expression^Err_044)*
assignmentExpression <-  assignment  /  conditionalExpression
assignment      <-  leftHandSide AssignmentOperator expression^Err_045
leftHandSide    <-  primary  /  qualIdent
AssignmentOperator <-  '=' ![=]  /  '*='  /  '/='  /  '%='  /  '+='  /  '-='  /  '<<='  /  '>>='  /  '>>>='  /  '&='  /  '^='  /  '|='
lambdaExpression <-  lambdaParameters '->' lambdaBody^Err_046
