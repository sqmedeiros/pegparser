...
switchLabel     <-  CASE (constantExpression  /  enumConstantName)^Err_069 ':'^Err_070  /  DEFAULT ':'
enumConstantName <-  Identifier^Err_071
...
tryStatement    <-  TRY (block (catchClause* finally  /  catchClause+)  /  resourceSpecification block^Err_072 (catchClause  /  !('}'  /  '{'  /  WHILE  /  VOID  /  TRY  /  THROW  /  THIS  /  SYNCHRONIZED  /  SWITCH  /  SUPER  /  STRICTFP  /  STATIC  /  SHORT  /  RETURN  /  PUBLIC  /  PROTECTED  /  PRIVATE  /  NEW  /  Literal  /  LONG  /  Identifier  /  INT  /  IF  /  FOR  /  FLOAT  /  FINALLY  /  FINAL  /  ENUM  /  ELSE  /  DOUBLE  /  DO  /  DEFAULT  /  CONTINUE  /  CLASS  /  CHAR  /  CASE  /  BYTE  /  BREAK  /  BOOLEAN  /  ASSERT  /  ABSTRACT  /  '@'  /  ';'  /  '--'  /  '++'  /  '(') %{Err_073} .)* (finally  /  !('}'  /  '{'  /  WHILE  /  VOID  /  TRY  /  THROW  /  THIS  /  SYNCHRONIZED  /  SWITCH  /  SUPER  /  STRICTFP  /  STATIC  /  SHORT  /  RETURN  /  PUBLIC  /  PROTECTED  /  PRIVATE  /  NEW  /  Literal  /  LONG  /  Identifier  /  INT  /  IF  /  FOR  /  FLOAT  /  FINAL  /  ENUM  /  ELSE  /  DOUBLE  /  DO  /  DEFAULT  /  CONTINUE  /  CLASS  /  CHAR  /  CASE  /  BYTE  /  BREAK  /  BOOLEAN  /  ASSERT  /  ABSTRACT  /  '@'  /  ';'  /  '--'  /  '++'  /  '(') %{Err_074} .)?)^Err_075
catchClause     <-  CATCH '('^Err_076 catchFormalParameter^Err_077 ')'^Err_078 block^Err_079
catchFormalParameter <-  (variableModifier  /  !Identifier %{Err_080} .)* catchType^Err_081 variableDeclaratorId^Err_082
catchType       <-  unannClassType ('|' ![=|] classType)*
finally         <-  FINALLY block^Err_083
resourceSpecification <-  '('^Err_084 resourceList^Err_085 (';'  /  !')' %{Err_086} .)? ')'^Err_087
resourceList    <-  resource^Err_088 (';' resource  /  !(';'  /  ')') %{Err_089} .)*
resource        <-  variableModifier* unannType variableDeclaratorId '=' !'=' expression
expression      <-  lambdaExpression  /  assignmentExpression
primary         <-  primaryBase primaryRest*
primaryBase     <-  THIS  /  Literal  /  parExpression  /  SUPER ('.' typeArguments? Identifier arguments  /  '.' Identifier  /  '::' typeArguments? Identifier)  /  NEW (classCreator  /  arrayCreator)  /  qualIdent ('[' expression ']'  /  arguments  /  '.' (THIS  /  NEW classCreator  /  typeArguments Identifier arguments  /  SUPER '.' typeArguments? Identifier arguments  /  SUPER '.' Identifier^Err_090  /  SUPER '::' (typeArguments  /  !Identifier %{Err_091} .)? Identifier^Err_092 arguments^Err_093)  /  ('[' ']')* '.' CLASS  /  '::' typeArguments? Identifier)  /  VOID '.' CLASS^Err_094  /  basicType ('[' ']')* '.' CLASS  /  referenceType '::' typeArguments? NEW  /  arrayType '::' NEW
...
infixExpression <-  unaryExpression (infixOperator unaryExpression  /  INSTANCEOF referenceType^Err_098)*
infixOperator   <-  '||'  /  '&&'  /  '|' ![=|]  /  '^' ![=]  /  '&' ![=&]  /  '=='  /  '!='  /  '<' ![=<]  /  '>' ![=>]  /  '<='  /  '>='  /  '<<' ![=]  /  '>>' ![=>]  /  '>>>' ![=]  /  '+' ![=+]  /  '-' ![-=>]  /  '*' ![=]  /  '/' ![=]  /  '%' ![=]
conditionalExpression <-  infixExpression ('?' expression ':' expression)*
assignmentExpression <-  assignment  /  conditionalExpression
assignment      <-  leftHandSide AssignmentOperator expression^Err_099
leftHandSide    <-  primary  /  qualIdent
AssignmentOperator <-  '=' ![=]  /  '*='  /  '/='  /  '%='  /  '+='  /  '-='  /  '<<='  /  '>>='  /  '>>>='  /  '&='  /  '^='  /  '|='
lambdaExpression <-  lambdaParameters '->' lambdaBody^Err_100
...
lambdaBody      <-  (expression  /  block)^Err_101
