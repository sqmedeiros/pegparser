...
localopt        <-  'local'?
import          <-  'local' NAME '=' 'import' ('(' STRINGLIT^Err_008 ')'^Err_009  /  STRINGLIT^Err_010)^Err_011
foreign         <-  'local' NAME^Err_012 '='^Err_013 'foreign'^Err_014 'import'^Err_015 ('(' STRINGLIT^Err_016 ')'^Err_017  /  STRINGLIT^Err_018)^Err_019
rettypeopt      <-  (':' rettype^Err_020)?
paramlist       <-  (param (',' param^Err_021)*)?
param           <-  NAME ':'^Err_022 type^Err_023
decl            <-  NAME (':' type)?
decllist        <-  decl (',' decl)*
...
statement       <-  ';'  /  'do' block 'end'  /  'while' exp^Err_026 'do'^Err_027 block 'end'^Err_028  /  'repeat' block 'until'^Err_029 exp^Err_030  /  'if' exp^Err_031 'then'^Err_032 block elseifstats elseopt 'end'^Err_033  /  'for' decl^Err_034 '='^Err_035 exp^Err_036 ','^Err_037 exp^Err_038 (',' exp^Err_039)? 'do'^Err_040 block 'end'^Err_041  /  'local' decllist '=' explist  /  varlist '=' explist  /  suffixedexp
elseifstats     <-  elseifstat*
elseifstat      <-  'elseif' exp^Err_042 'then'^Err_043 block
elseopt         <-  ('else' block)?
returnstat      <-  'return' explist? ';'?
exp             <-  e1
e1              <-  e2 ('or' e2^Err_044)*
e2              <-  e3 ('and' e3^Err_045)*
e3              <-  e4 (('=='  /  '~='  /  '<='  /  '>='  /  '<'  /  '>') e4^Err_046)*
e4              <-  e5 ('|' e5^Err_047)*
e5              <-  e6 ('~' !'=' e6^Err_048)*
e6              <-  e7 ('&' e7^Err_049)*
...
e10             <-  e11 (('*'  /  '%%'  /  '/'  /  '//') e11^Err_053)*
e11             <-  ('not'  /  '#'  /  '-'  /  '~')* e12
e12             <-  castexp ('^' e11^Err_054)?
suffixedexp     <-  prefixexp expsuffix+
expsuffix       <-  funcargs  /  ':' NAME funcargs  /  '[' exp^Err_055 ']'^Err_056  /  '.' !'.' NAME^Err_057
prefixexp       <-  NAME  /  '(' exp ')'
castexp         <-  simpleexp 'as' type^Err_058  /  simpleexp
...
Err_012         <-  (!'=' EatToken)*
Err_013         <-  (!'foreign' EatToken)*
Err_014         <-  (!'import' EatToken)*
Err_015         <-  (!(STRINGLIT  /  '(') EatToken)*
Err_016         <-  (!')' EatToken)*
...
Err_021         <-  (!')' EatToken)*
Err_022         <-  (!('{'  /  'value'  /  'string'  /  'nil'  /  'integer'  /  'float'  /  'boolean'  /  NAME  /  '(') EatToken)*
Err_023         <-  (!(','  /  ')') EatToken)*
Err_024         <-  (!('{'  /  'value'  /  'string'  /  'nil'  /  'integer'  /  'float'  /  'boolean'  /  NAME  /  '(') EatToken)*
Err_025         <-  (!('end'  /  NAME  /  ';') EatToken)*
Err_026         <-  (!'do' EatToken)*
Err_027         <-  (!('while'  /  'return'  /  'repeat'  /  'local'  /  'if'  /  'for'  /  'end'  /  'do'  /  NAME  /  ';'  /  '(') EatToken)*
...
Err_031         <-  (!'then' EatToken)*
Err_032         <-  (!('while'  /  'return'  /  'repeat'  /  'local'  /  'if'  /  'for'  /  'end'  /  'elseif'  /  'else'  /  'do'  /  NAME  /  ';'  /  '(') EatToken)*
...
Err_038         <-  (!('do'  /  ',') EatToken)*
Err_039         <-  (!'do' EatToken)*
Err_040         <-  (!('while'  /  'return'  /  'repeat'  /  'local'  /  'if'  /  'for'  /  'end'  /  'do'  /  NAME  /  ';'  /  '(') EatToken)*
...
Err_044         <-  (!('}'  /  'while'  /  'until'  /  'then'  /  'return'  /  'repeat'  /  'record'  /  'local'  /  'if'  /  'function'  /  'for'  /  'end'  /  'elseif'  /  'else'  /  'do'  /  NAME  /  ']'  /  ';'  /  ','  /  ')'  /  '('  /  !.) EatToken)*
Err_045         <-  (!('}'  /  'while'  /  'until'  /  'then'  /  'return'  /  'repeat'  /  'record'  /  'or'  /  'local'  /  'if'  /  'function'  /  'for'  /  'end'  /  'elseif'  /  'else'  /  'do'  /  NAME  /  ']'  /  ';'  /  ','  /  ')'  /  '('  /  !.) EatToken)*
...
Err_057         <-  (!('~='  /  '~'  /  '}'  /  '|'  /  '{'  /  'while'  /  'until'  /  'then'  /  'return'  /  'repeat'  /  'record'  /  'or'  /  'local'  /  'if'  /  'function'  /  'for'  /  'end'  /  'elseif'  /  'else'  /  'do'  /  'as'  /  'and'  /  STRINGLIT  /  NAME  /  '^'  /  ']'  /  '['  /  '>>'  /  '>='  /  '>'  /  '=='  /  '='  /  '<='  /  '<<'  /  '<'  /  ';'  /  ':'  /  '//'  /  '/'  /  '..'  /  '.'  /  '-'  /  ','  /  '+'  /  '*'  /  ')'  /  '('  /  '&'  /  '%%'  /  !.) EatToken)*
